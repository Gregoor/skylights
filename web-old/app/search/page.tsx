...
import type { Rels } from "@/books/actions";
import { relsAtom, syncRelsEffect } from "@/books/atoms";
import { Book, BookCard } from "@/books/BookItem";
import { Card } from "@/ui";
...
const Hit = ({ hit }: { hit: Book }) => <BookCard book={hit} />;

export function ClientSearchPage({ defaultRels }: { defaultRels: Rels }) {
